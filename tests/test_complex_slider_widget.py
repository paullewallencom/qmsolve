...
class TestComplexSliderWidget(unittest.TestCase):
    ...
    def test_widget_instantiation(self):
        ...
        self.assertIsInstance(
            widget, AxesWidget, "Widget should inherit from AxesWidget"
            )
    ...
    def test_get_artist(self):
        ...
        self.assertTrue(
            artist in self.ax.lines,
            "get_artist should return a valid matplotlib line artist"
            )
    ...
    def test_click_event(self):
        ...
        event.x, event.y = (self.ax.bbox.xmin + self.ax.bbox.xmax) / 2, (
            self.ax.bbox.ymin + self.ax.bbox.ymax) / 2
        widget._click(event)
        self.assertTrue(
            widget._is_click, "_click method should set _is_click to True")
    ...
    def test_release_event(self):
        ...
        self.assertFalse(
            widget._is_click,
            "_release method should reset _is_click to False")
